...
export const NFTTitle = ({title,subTitle,titleSize,subtTitleSize}) => {
	return (
		<View>
			<Text style={{fontFamily:FONTS.semiBold,fontSize:titleSize,color:COLORS.primary}}>{title}</Text>
			<Text style={{fontFamily:FONTS.regular,fontSize:subtTitleSize,color:COLORS.primary}}>{subTitle}</Text>
		</View>
	);
};
